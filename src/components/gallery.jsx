   ...
   const images=[
    ...
    return(
        <div className="flex justify-center items-center mb-5 md:ml-[150px]">
            ...
            <a href={`https://api.whatsapp.com/send?phone=+2348101657733 &text= Hello Imperative WristHub,lets negotiate on (${item.id},${item.pricelow})`} className="absolute bottom-[10px]">
